...
- **China (recommended in mainland China — jsDelivr mirror):**
  https://cdn.jsdelivr.net/gh/AugeasTechnologies/stovyn-hejia@main/app/StovynBench-1.4.5.apk
- APK (GitHub): [`app/StovynBench-1.4.5.apk`](app/StovynBench-1.4.5.apk)
- ZIP (use this if your browser blocks the .apk): [`app/StovynBench-1.4.5.zip`](app/StovynBench-1.4.5.zip) — unzip to get the .apk
- Or the release page: https://github.com/AugeasTechnologies/stovyn-ota/releases/tag/bench-v1.4.5
...
The app **self-updates** after that (one-time sideload). From v1.4.5 the updater is China-aware:
